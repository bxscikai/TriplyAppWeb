      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#contact" className="text-muted-foreground hover:text-triply-600 transition-colors">Discord</a></li>
              <li><a href="#contact" className="text-muted-foreground hover:text-triply-600 transition-colors">Email</a></li>
              <li><a href="#contact" className="text-muted-foreground hover:text-triply-600 transition-colors">Support Us</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-triply-600 transition-colors">Privacy Policy</a></li>
            </ul>
          </div>
        </div>
